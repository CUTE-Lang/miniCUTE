...
transpileProgram :: MainProgramLLMC -> GMachineProgram
...
transpileSc :: MainSupercombinatorLLMC -> GMachineSupercombinator
...
transpileSE :: TranspilerE MainExpressionLLMC
...
transpileNE :: TranspilerE MainExpressionLLMC
...
transpileLet :: TranspilerE MainExpressionLLMC -> TranspilerE (IsRecursive, [MainLetDefinitionLLMC], MainExpressionLLMC)
...
transpileLetDefs :: TranspilerE [MainLetDefinitionLLMC]
...
transpileLetRecDefs :: TranspilerE [MainLetDefinitionLLMC]
...
updateLetEnv :: [MainLetDefinitionLLMC] -> TranspilerEEnv -> TranspilerEEnv
...
transpileMatch :: TranspilerE MainExpressionLLMC -> (Integer -> TranspilerE MainExpressionLLMC) -> TranspilerE (MainExpressionLLMC, [MainMatchCaseLLMC])
transpileMatch transpileBody transpileCase env (body, mCases) = bodyInst <> [IMatch (makeMatchTable transpileCase env mCases)]
  where
    bodyInst = transpileBody env body

makeMatchTable :: (Integer -> TranspilerE MainExpressionLLMC) -> TranspilerEEnv -> [MainMatchCaseLLMC] -> MatchTable
makeMatchTable transpileCase env = MatchTable . fmap (makeMatchEntry transpileCase env)

makeMatchEntry :: (Integer -> TranspilerE MainExpressionLLMC) -> TranspilerEEnv -> MainMatchCaseLLMC -> MatchEntry
