declare void @minicute__node__update_NInteger(i32, i8*)
declare void @minicute__node__update_NIndirect(i8*, i8*)
declare i32 @printf(i8* noalias nocapture, ...)

%struct.minicute__node = type { i8 }
%struct.minicute__node__NEmpty = type { i8 }
%struct.minicute__node__NInteger = type { i8, i32 }
%struct.minicute__node__NStructure = type { i8, i32, i32, i8** }
%struct.minicute__node__NIndirect = type { i8, i8* }
%struct.minicute__node__NGlobal = type { i8, i8*, i32 }
...
define dso_local void @minicute__user_defined__f__code() #1 {
  entry:
    ...
    %4 = load i8*, i8** %3
    call void @minicute__node__update_NInteger(i32 %1, i8* %4)
...
define dso_local void @minicute__user_defined__main__code() #1 {
  entry:
    ...
    call void @minicute__util__print_stack_size()
    ; -- debug
    call void @minicute__util__print_top__node__tag()
    ...
    %10 = load i8*, i8** %9
    call void @minicute__node__update_NIndirect(i8* %8, i8* %10)
    ; -- debug
    call void @minicute__util__print_stack_size()
    ; -- debug
    call void @minicute__util__print_top__node__tag()
...
define private dso_local void @minicute__util__unwind() {
  ...
  unwind:
    ...
    %unwind.2 = bitcast i8* %unwind.1 to %struct.minicute__node*
    %unwind.3 = getelementptr inbounds %struct.minicute__node, %struct.minicute__node* %unwind.2, i32 0, i32 0
  ...
  unwind_NIndirect_tag:
    %unwind.NIndirect.0 = bitcast i8* %unwind.1 to %struct.minicute__node__NIndirect*
    %unwind.NIndirect.1 = getelementptr inbounds %struct.minicute__node__NIndirect, %struct.minicute__node__NIndirect* %unwind.NIndirect.0, i32 0, i32 1
  ...
  unwind_NGlobal_tag:
    ...
    %unwind.NGlobal.0 = bitcast i8* %unwind.1 to %struct.minicute__node__NGlobal*
    %unwind.NGlobal.1 = getelementptr inbounds %struct.minicute__node__NGlobal, %struct.minicute__node__NGlobal* %unwind.NGlobal.0, i32 0, i32 1
...
@minicute__util__print_top__node__tag.format = private unnamed_addr constant [20 x i8] c"top node tag is %d\0A\00", align 1
define private dso_local void @minicute__util__print_top__node__tag() unnamed_addr #0 {
  entry:
    %0 = load i8**, i8*** @asp
    %1 = getelementptr inbounds i8*, i8** %0, i32 0
    %2 = load i8*, i8** %1
    %3 = bitcast i8* %2 to %struct.minicute__node*
    %4 = getelementptr inbounds %struct.minicute__node, %struct.minicute__node* %3, i32 0, i32 0
    %5 = load i8, i8* %4
    ; 'sext' is required since -1 is a valid tag
    %6 = sext i8 %5 to i32
    %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @minicute__util__print_top__node__tag.format, i32 0, i32 0), i32 %6)
...
define private dso_local void @minicute__util__print_top_NInteger() unnamed_addr #0 {
  entry:
    ...
    %1 = getelementptr inbounds i8*, i8** %0, i32 0
    %2 = load i8*, i8** %1
    %3 = bitcast i8* %2 to %struct.minicute__node__NInteger*
    %4 = getelementptr inbounds %struct.minicute__node__NInteger, %struct.minicute__node__NInteger* %3, i32 0, i32 1
    %5 = load i32, i32* %4
